...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
      if ($request->permissionType == 'basic') {
        ...
        Session::flash('success', __('messages.permission_added'));
        ...
        if (count($crud) > 0) {
          ...
          Session::flash('success', __('messages.permissions_added'));
          return redirect()->route('permissions.index');
        }
      } else {
    ...
    public function update(Request $request, $id)
    {
      ...
      Session::flash('success', __('messages.permission_updated', ['name' => $permission->display_name]));
